...
export { default as BtnPrimary2 } from './atoms/BtnPrimary2.svelte'
...
export { default as Header2 } from './organisms/Header2.svelte'
...
export { default as Concept3 } from './organisms/Concept3.svelte'
